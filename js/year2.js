...
window.addEventListener('load', function() {
  ...
  con.query($query, "CENG 2%", function(err, rows) {
      if(err){
      ...
      con.query($query, [2, "CENG 2%"], function(err, rows) {
          if(err){
              console.log(err);
              return;
          }
          ...
          $(function(){
            ...
            $('.right td.drop').droppable({
              ...
              onDrop:function(e,source){
                ...
                con.query($query, [2, cell, courseCode], function(err, rows) {
                    if(err){
                        console.log(err);
                        return;
                    }
                ...
                if (prev !== -1) {
                  ...
                  con.query($query, [2, prev], function(err, rows) {
                      if(err){
                          console.log(err);
                          return;
                      }
